...
<script>
        ...
        try {
            ...
            if (savedStudents) {
                ...
                if (students.length > 0 && !students[0].id) {
                     students = students.map((s, index) => ({ ...s, id: 's' + (index + 1) }));
                }
        ...
        students = []; // Clear existing students if any
         ...
         Object.keys(studentLists).forEach(className => {
             ...
             studentLists[className].forEach(studentName => {
                 students.push({ id: 's' + (students.length + 1), name: studentName, course: classInfo.course, class: className, unit: classInfo.unit, disciplines: [] });
             });
         });
     }
    ...
    function populateProfessorDisciplineCheckboxes() { /* Not used anymore with the new assignment structure */ }
    function populateProfessorClassCheckboxes() { /* Not used anymore with the new assignment structure */ }
    function populateEditProfessorDisciplineCheckboxes(assignedDisciplines = []) { /* Not used anymore with the new assignment structure */ }
    function populateEditProfessorClassCheckboxes(assignedClasses = []) { /* Not used anymore with the new assignment structure */ }
